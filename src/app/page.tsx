  ...
  return (
    <>
      <div className="bg-[#D1A7E5] text-black min-h-screen flex flex-col items-center justify-start pt-12">
        ...
        {/* Card Container */}
        <div className="p-4 border-2 border-[#7D3C98] rounded-2xl bg-gradient-to-r from-[#1C1C1C]  to-[#7D3C98] shadow-md flex flex-col items-center w-11/12 max-w-md">
          <div className="text-center">
            ...
            {/* Progress Bar */}
            <div className="progressBar mt-4 w-full bg-[#D1A7E5] rounded-full h-2">
              <div
                className="progress bg-[#7D3C98] h-full rounded-2xl"
                style={{
                  width: `${Math.min(
        ...
        {/* Form Section */}
        <form onSubmit={handleSubmit} className="mt-4 w-11/12 max-w-md flex items-center gap-2">
          <input
            type="text"
            placeholder="Write Your Task"
            value={task}
            onChange={(e) => setTask(e.target.value)}
            className="flex-1 p-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7D3C98]"
          />
          <button
            type="submit"
